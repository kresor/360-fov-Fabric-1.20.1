...
public final class Main implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        LOGGER.info("360 FOV 1.20.1 experimental backport initialized (captureScale={}, skipBackFace={})",
            Fov360Config.INSTANCE.getCaptureScale(), Fov360Config.INSTANCE.isSkipBackFace());
    }
}
